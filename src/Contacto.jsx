...
const Contacto = () => {
  return (
    <div className='row text-center mt-5 contacBox'>
        <div className="col">
            <img src={logo} alt="logo" className='img-fluid'/>
            <h3 className='titulo-dos'>Servicios y soluciones</h3>
            <h4 className='titulo-dos'>eléctricas</h4>
            <div className="col d-flex justify-content-evenly">
              <a href="https://www.facebook.com/jairo.torrecilla.9?mibextid=LQQJ4d">
